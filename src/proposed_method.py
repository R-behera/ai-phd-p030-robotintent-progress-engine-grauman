...
METHOD_SPEC = {
    "algorithm_id": "P030-Grauman-ComputerVision",
    "algorithm_name": "GraumanCounterfactualComputerVisionCalibrateMatrix",
    ...
    "decision_rule": "Rank seed cases by vision-specific priority score with Grauman-aligned focus term 'Computer vision'.",
    "review_threshold": 0.43,
    "shift_weights": {
        "viewpoint": 0.05,
        "context": 0.1,
        "annotation": 0.07,
