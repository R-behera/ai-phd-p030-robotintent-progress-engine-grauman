...
class ValueAddDemoTest(unittest.TestCase):
    def test_value_add_demo_runs(self):
        result = run_demo()
        self.assertEqual(result["professor"], 'Kristen Grauman')
    ...
    def test_profile_is_professor_specific(self):
        ...
        self.assertEqual(profile["research_area"], 'Computer vision, video understanding, egocentric/embodied perception')
