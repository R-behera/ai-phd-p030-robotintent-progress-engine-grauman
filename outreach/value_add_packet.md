...
This repository is currently a **research proposal and execution scaffold**, not a completed result. Use it to show Professor Grauman that you understand the research area and can contribute a concrete, reproducible artifact.
...
- **Research area from CSV:** Computer vision, video understanding, egocentric/embodied perception
- **Representative paper from CSV:** Ego4D: Around the World in 3,000 Hours of Egocentric Video; 2022; CVPR
